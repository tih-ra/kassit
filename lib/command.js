      ...
      appoptions = [
        {
          ...
          "switch": '--controller',
          match: /^[A-z]/,
          eval: 'generator.controller(app,param)',
          show: 'creates ./client/controllers/[CTRL]_controller.coffee'
        }, {
          "switch": '--restful',
          match: /^[A-z]/,
          ...
          show: 'scaffolds Model/View/Controller/Restful'
        }, {
          space: true
        }, {
          "switch": '--watch',
